...
export const siteConfig: SiteConfig = {
	title: "Wangtanzhi 的 blog",
	subtitle: "记录与分享",
	siteURL: "https://wangtanzhi6.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	anime: {
		mode: "meting", // 番剧页面模式："bangumi" 使用Bangumi API，"local" 使用本地配置，"bilibili" 使用Bilibili API
	},
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/383940966",
					external: true,
